    ...
    render() {
        return (
          ...
          <div className="profile_data">
            ...
            <p><span>School Class: </span>{this.state.schoolClass.grade}/{this.state.schoolClass.section}, {this.state.schoolClass.schoolYear}</p>
            <p><span>Parent: </span>{this.state.parent.firstName} {this.state.parent.lastName}</p>
          </div>
          <div className="edit_details">
            <Link
              onClick={() => this.props.history.push('/admin/users/students/update/' + this.state.id)}
